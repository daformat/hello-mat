...
export const Header = () => (
  <div className={styles.header}>
    ...
    <Link
      href="https://subtitles-live.com"
      aria-label="Subtitles, live captions for your Mac"
      target="_blank"
      rel="noopener"
    >
      <LogoSubtitles />
